...
(ps📚:可能很多人被我吓的不敢选这门课了😓but,这门课除了博弈论内容很有意思以外，还适合对强化学习感兴趣的童鞋去学习🤩。虽然multi-agent并不是强化学习，但是现在很多的multi-agent都是在用强化学习的内容去解决问题的🙃我曾经听过UCL的教授的一个讲座，他就是将进化算法，multi-agent以及强化学习结合起来，解决自动驾驶的问题的。同时如果你留意最近的AI顶会，强化学习相关的论文中有不少是设计到multi-agent的。)
